...
rule align_reads_spikein:
	...
	threads: 8
	params:
		yeast_genome_idx = "/home/administrator/yeast_genome_bowtie2/sacCer" #path to genome sample
	shell:
...
rule sort_bam_spikein:
    ...
    shell:
        "java -jar /home/administrator/scripts/picard.jar SortSam I={input.bam_files} "
        "O={output} "
...
rule mark_duplicates_spikein:
	...
	shell:
		"java -jar /home/administrator/scripts/picard.jar MarkDuplicates I={input} "
		"O={output.dupes} "
		"M={output.metrics} "
		"VALIDATION_STRINGENCY=LENIENT"
