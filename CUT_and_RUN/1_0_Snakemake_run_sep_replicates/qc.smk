...
rule trimming:
	...
	shell:
		"java -jar /home/administrator/Trimmomatic-0.39/trimmomatic-0.39.jar PE -phred33 " #fastp
		"{input.read1} {input.read2} "
		"{output.paired_read1} {output.unpaired_read1} {output.paired_read2} {output.unpaired_read2} "
		"ILLUMINACLIP:/home/administrator/Trimmomatic-0.39/adapters/TruSeq3-PE.fa:2:15:4:1:true MINLEN:20"
